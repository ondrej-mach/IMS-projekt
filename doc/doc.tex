...
Modul domácnosti periodicky sčítá výkon všech spotřebičů a ukládá ho do jedné sdílené proměnné.
Toto je jeho výstup, který je monitorován monitorovacím zařízením.
